DayZ Payday Spawn Loadout Files For Console and PC Community Servers Instructions & Terms Of Use

When installed correctly these files will spawn fresh players with a Payday(M16) loadout with gear and randomised suit.

Limited Testing on PC Chernarus Local Experimental Server DAYZ Version 1.25 Jul 24.
...
Upload "payday-loadout.json" from the extracted files to inside the "custom" folder of the mission directory on your server.
...
EG:
        ...
        "spawnGearPresetFiles": ["custom/payday-loadout.json"],
        "StaminaData":
...
Edit it to look like this: 
	...
	OR if your server already has a custom loadout, and you want to keep it too, it should look like this:
	
	"spawnGearPresetFiles": ["custom/payday-loadout.json","custom/your-other-loadout.json"],
